<%-- 
    Document   : header
    Created on : Jul 2, 2022, 11:01:56 AM
    Author     : AMR
--%>
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="menuAppController?page=home">Welcome : ${usr.usrFullName}</a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="processRequest?page=insertProduct">Create new Product</a></li>
                                <li><a href="menuAppController?page=showProducts">Show All Products</a></li>
